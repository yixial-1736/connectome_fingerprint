...
Contrast2 = 'Txt'
Network = 'multi'
X_test = np.genfromtxt('/ConnectomeFingerprinting/Outputs/Matrices/' + Hypothesis + '/' + Network + '/lh.'+subname+'_norm.csv', delimiter=',')
y_test = np.genfromtxt('/ConnectomeFingerprinting/Outputs/Scan_Activations/' + Hypothesis + '/' + Contrast + '/lh.' +subname+'.csv', delimiter=',')
...
for n in range(22):
    ...
    for sub in sublist:
        data = np.genfromtxt('/ConnectomeFingerprinting/Outputs/Matrices/' + Hypothesis + '/' + Network + '/lh.'+sub+'_norm.csv', delimiter=',')
        activation = np.genfromtxt('/ConnectomeFingerprinting/Outputs/Scan_Activations/'+ Hypothesis + '/' + Contrast +'/lh.'+sub+'.csv', delimiter = ',')
    ...
    y_val = np.genfromtxt('/ConnectomeFingerprinting/Outputs/Scan_Activations/'+ Hypothesis + '/' + Contrast + '/lh.'+val_sub+'.csv', delimiter=',')
    X_val = np.genfromtxt('/ConnectomeFingerprinting/Outputs/Matrices/' + Hypothesis + '/' + Network + '/lh.'+val_sub+'_norm.csv', delimiter=',')
...
for sub in subslist:
    data2 = np.genfromtxt('/ConnectomeFingerprinting/Outputs/Matrices/' + Hypothesis + '/' + Network + '/lh.'+subname+'_norm.csv', delimiter=',')
    X = np.vstack((X,data2))
X = np.delete(X,0,0)
...
for sub in subslist:
    activation2 = np.genfromtxt('/ConnectomeFingerprinting/Outputs/Scan_Activations/'+ Hypothesis + '/' + Contrast + '/lh.'+sub+'.csv', delimiter = ',')
